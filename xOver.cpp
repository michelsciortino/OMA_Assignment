...
inline void copyColour(int x, int y, int col, vector<vector<int> > &parentCpys, vector<int> &osp, vector<vector<int> > &parentCard, Graph &g)
{
...
inline void multiParent(vector<int> &osp, vector<int> &parents, Graph &g, int k, vector<vector<int> > &population, bool doKempeMutation)
{
	...
	for(col = 1; col<=k; col++){
		...
		tabuList[y] = col + Q; // PROBLEM: y has not been initialized!
...
inline void GGA(vector<int> &osp, vector<int> &parents, Graph &g, int k, vector<vector<int> > &population)
{
...
inline void nPointX(vector<int> &osp, vector<int> &parents, Graph &g, int k, vector<vector<int> > &population)
{
	double xrate = 0.5;
