...
inline void addHorizontalLine(int row, vector<vector<cell> > &vals, int n, vector<bool> &rowLined,
...
inline void addVerticalLine(int col, vector<vector<cell> > &vals, int n, vector<bool> &rowLined,
			  vector<bool> &colLined, vector<int> &rowZeros, vector<int> &colZeros, int &numZerosRemaining, int &linesAdded)
{
	//Add a vertical line at col (this should not be lined currently. Update the arrays
	int r;
...
inline void coverMin(vector<vector<cell> > &vals, int n, vector<bool> &rowLined, vector<bool> &colLined,
...
inline bool checkRows(vector<vector<cell> > &vals, int n, vector<bool> &rowLined, vector<bool> &colLined, vector<int> &rowZeros,
...
inline bool checkColumns(vector<vector<cell> > &vals, int n, vector<bool> &rowLined, vector<bool> &colLined, vector<int> &rowZeros,
				  vector<int> &colZeros, int &numZerosRemaining, int &linesAdded, vector<int> &matching)
{
...
inline void updateVals(vector<vector<cell> > &vals, int n, vector<bool> &rowLined, vector<bool> &colLined)
{
